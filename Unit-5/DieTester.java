...
public class DieTester {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Test rolling of 4-sided yahtzee dice: " + fourSidedQuintetOfDice.roll());
		System.out.println(
				"Test .toString() of 4-sided yahtzee dice: " + fourSidedQuintetOfDice.toString());
		System.out.print("Test getDiceValues() of 4-sided yahtzee dice: "
				+ fourSidedQuintetOfDice.getDiceValues());
