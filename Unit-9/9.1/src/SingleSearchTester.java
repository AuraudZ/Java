...
public class SingleSearchTester {
	...
	public static void main(String[] args){
		...
		int numToSearchFor = 51; // test for numbers present, not present, at the "edges", etc.
		int[] arrayToSearchIn = test1; // arrayToSearchIn will point to the array you choose
		...
		int index = SearchLibrary.binarySearch(numToSearchFor, arrayToSearchIn); 
		...
		int index2 = SearchLibrary.sequentialSearch(numToSearchFor, arrayToSearchIn);
		String message2 = "";
