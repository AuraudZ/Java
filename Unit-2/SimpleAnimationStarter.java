...
public class SimpleAnimationStarter extends JPanel implements ActionListener {
    ...
    public void drawFrame(Graphics g, int frameNumber, int width, int height) {
        ...
        /*
         * NOTE: To get a different animation, just erase the contents of this subroutine and
         * substitute your own. If you don't fill the picture with some other color, the background
         * color will be white. The sample code here just shows the frame number.
         */

        g.drawString("Frame number " + frameNumber, 40, 50);
        g.drawArc(0, 0, 200, 200, 20, 10);
