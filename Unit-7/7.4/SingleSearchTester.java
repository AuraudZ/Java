...
public class SingleSearchTester {
	...
	public static void main(String[] args) {
		...
		// They will be sorted (although test1 is alrady sorted to help you visualize the correct
		// answer)
		int[] test1 = new int[] {2, 9, 11, 15, 28, 33, 40, 47, 51, 64, 76, 77, 82, 85, 94};
		int[] test2 = new int[] {67, 35, 51, 45, 40, 50, 37, 55, 20};
		int[] test3 = ArrayImporter.readArrayFile("smallArray.txt"); // for testing, after sorting,
		int[] test4 = ArrayImporter.readArrayFile("largeArray.txt"); // '1760909555' will be at
		// index 81918

		// ***Enter in your own number to search for and array to search in***
		int numToSearchFor = 870046809;
		int[] arrayToSearchIn = test4; // arrayToSearchIn will point to the array you choose


		// Remember, Binary Search requires a sorted list...
		System.out.print("***Sorting the lists...");
		Arrays.sort(arrayToSearchIn); // sort() doesn't return int[], array simply gets modified in
										// place
		System.out.println("...sorted.\n");

		System.out.println("***Searching the list for a single item (Binary Search)***");
		int index = SearchLibrary.binarySearch(numToSearchFor, arrayToSearchIn, true); // for
																						// default,
																						// should
																						// return
																						// index '2'
		...
		int index2 = SearchLibrary.sequentialSearch(numToSearchFor, arrayToSearchIn, true); // for
																							// default,
																							// should
																							// return
																							// index
