...
public class SortLibraryTest {
	...
	public void setUp() throws Exception {
		...
		copyOflongOddReversedArray = Arrays.copyOf(longOddReversedArray, longOddReversedArray.length);
		...
		copyOfshortAlmostInOrderArray = Arrays.copyOf(shortAlmostInOrderArray, shortAlmostInOrderArray.length);
	
		shortRandomArrayForMergeSort = readArrayFile("shortRandomArrayForMergeSort.txt");
		copyOfshortRandomArrayForMergeSort = Arrays.copyOf(shortRandomArrayForMergeSort, shortRandomArrayForMergeSort.length);
	}
	...
	public void testInsertionSortInorderFasterThanReverseData() {		
		...
		//System.out.println("inorder time " + timeForInOrderSort + ", reversed time: " + timeForReversedSort);
